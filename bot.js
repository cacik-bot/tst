...
const rest = new REST({ version: '10' }).setToken(ayarlar.botToken);
rest.put(Routes.applicationCommands("1040654047532818462"), { body: [] })
	.then(() => console.log('Komutlar sıfırlandı!'))
	.catch(console.error);
*/  
